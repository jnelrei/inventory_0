...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      <li class="<?php echo $currentPage === 'sa_dashboard.php' ? 'active current-page' : ''; ?>">
        <a href="../dashboard/sa_dashboard.php">
      ...
      <li class="<?php echo $currentPage === 'user.php' ? 'active current-page' : ''; ?>">
