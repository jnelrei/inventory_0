  ...
  switch ($filter) {
    case 'daily':
      ...
      foreach ($orders_data as $row) {
        ...
        $hourly_data[$hour] = (int)$row['order_count'];
      }
    ...
    case 'weekly':
      ...
      $weekly_data = [];
      foreach ($orders_data as $row) {
        $weekly_data[$row['order_date']] = (int)$row['order_count'];
      }
    ...
    case 'monthly':
      ...
      $monthly_data = [];
      foreach ($orders_data as $row) {
        $monthly_data[$row['order_date']] = (int)$row['order_count'];
      }
    ...
    case 'yearly':
      ...
      foreach ($orders_data as $row) {
        $yearly_data[(int)$row['month_num']] = (int)$row['order_count'];
      }
