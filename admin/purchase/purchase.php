    ...
    cart.forEach((item, index) => {
        ...
        itemsList += `
            <div style="display: flex; align-items: center; padding: 12px 0; border-bottom: 1px solid #f0f0f0;">
                <div style="width: 60px; height: 60px; border-radius: 8px; overflow: hidden; margin-right: 12px; background: #f8f9fa; flex-shrink: 0;">
=======
        });
...
>>>>>>> bffd17eb2ccfbbfa430d2dfe62f4af6da5ab7e21
                ...
                <div style="flex: 1;">
<<<<<<< HEAD
                    <div style="font-weight: 600; color: #2A3F54; margin-bottom: 4px; font-size: 14px;">${item.itemName}</div>
    ...
    // Calculate max height: Each item is approximately 84px (60px image + 24px padding)
    // Show 4 items = 4 * 84px = 336px, add some buffer = 350px
    // If more than 4 items, make it scrollable
    const maxItemsToShow = 4;
    const itemHeight = 84; // 60px image + 24px padding (12px top + 12px bottom)
    const maxHeight = cart.length > maxItemsToShow ? (maxItemsToShow * itemHeight) + 'px' : 'auto';
    const shouldScroll = cart.length > maxItemsToShow;
    
    // Confirm checkout
    Swal.fire({
        title: '<div style="font-size: 28px; font-weight: 600; color: #2A3F54; margin-bottom: 5px;"><i class="fa fa-cash-register" style="color: #26B99A; margin-right: 10px;"></i>Confirm Checkout?</div>',
        html: `
            <div style="display: flex; gap: 20px; padding: 5px 0;">
                <!-- Left Column: Order Summary -->
                <div style="flex: 1; background: #f8f9fa; border-radius: 8px; padding: 20px; border: 1px solid #e9ecef; display: flex; flex-direction: column; ${shouldScroll ? 'max-height: 400px;' : ''}">
                    <div style="font-size: 12px; color: #999; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 15px; font-weight: 600; flex-shrink: 0;">Order Summary</div>
                    <div style="${shouldScroll ? 'max-height: ' + maxHeight + '; overflow-y: auto; overflow-x: hidden;' : 'overflow: visible;'} padding-right: 5px;" class="order-summary-scroll">
=======
...
<<<<<<< HEAD
                ...
                <div style="flex: 1; background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border-radius: 8px; padding: 20px; border: 2px solid #e9ecef;">
                    <div style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 2px solid #e0e0e0;">
                        <div style="display: flex; align-items: center; margin-bottom: 8px;">
                            ...
                            <span style="font-weight: 600; color: #666; font-size: 14px;">Total Amount:</span>
                        </div>
                        <div style="font-size: 28px; font-weight: bold; color: #26B99A; text-align: right;">₱ ${subtotal.toFixed(2)}</div>
                    </div>
                    
                    <div style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid #e0e0e0;">
                        <div style="display: flex; align-items: center; margin-bottom: 8px;">
                            <i class="fa fa-money" style="color: #26B99A; margin-right: 10px; font-size: 18px;"></i>
                            <span style="font-weight: 600; color: #666; font-size: 14px;">Payment:</span>
                        </div>
                        <div style="font-size: 24px; font-weight: 600; color: #2A3F54; text-align: right;">₱ ${payment.toFixed(2)}</div>
                    </div>
                    
                    <div style="margin-bottom: 20px;">
                        <div style="display: flex; align-items: center; margin-bottom: 8px;">
                            <i class="fa fa-exchange" style="color: #26B99A; margin-right: 10px; font-size: 18px;"></i>
                            <span style="font-weight: 600; color: #666; font-size: 14px;">Change:</span>
                        </div>
                        <div style="font-size: 24px; font-weight: bold; color: #26B99A; text-align: right;">₱ ${change.toFixed(2)}</div>
                    </div>
                    
                    <div style="background: #e8f5e9; border-radius: 6px; padding: 12px; margin-top: 20px; text-align: center; border: 1px solid #c8e6c9;">
                        <i class="fa fa-cubes" style="color: #26B99A; margin-right: 5px;"></i>
                        <span style="color: #2A3F54; font-weight: 600; font-size: 13px;">${cart.length} item(s) • ${totalItemsCount} total quantity</span>
=======
...
<<<<<<< HEAD
        ...
        confirmButtonText: '<i class="fa fa-check"></i> Yes, checkout!',
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            icon: null,
                            title: '<div style="font-size: 32px; font-weight: 700; color: #2A3F54; margin-bottom: 5px; text-align: center;"><i class="fa fa-check-circle" style="color: #26B99A; margin-right: 12px; font-size: 36px;"></i>Checkout Successful!</div>',
                            html: `
                                <div style="padding: 10px 0;">
                                    <div style="background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); border-radius: 12px; padding: 30px; border: 2px solid #26B99A; box-shadow: 0 4px 12px rgba(38, 185, 154, 0.15);">
                                        <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 2px solid rgba(38, 185, 154, 0.2);">
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                <div style="width: 48px; height: 48px; background: #26B99A; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                                    <i class="fa fa-shopping-cart" style="color: white; font-size: 20px;"></i>
                                                </div>
                                                <div>
                                                    <div style="font-size: 13px; color: #666; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px;">Total Amount</div>
                                                    <div style="font-size: 28px; font-weight: bold; color: #2A3F54;">₱ ${subtotal.toFixed(2)}</div>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; border-bottom: 1px solid rgba(0,0,0,0.1);">
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                <div style="width: 48px; height: 48px; background: #f0f0f0; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                                    <i class="fa fa-money" style="color: #26B99A; font-size: 20px;"></i>
                                                </div>
                                                <div>
                                                    <div style="font-size: 13px; color: #666; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px;">Payment</div>
                                                    <div style="font-size: 24px; font-weight: 600; color: #2A3F54;">₱ ${payment.toFixed(2)}</div>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div style="display: flex; justify-content: space-between; align-items: center; padding: 18px 0; background: rgba(38, 185, 154, 0.1); border-radius: 8px; margin-top: 10px; padding-left: 20px; padding-right: 20px;">
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                <div style="width: 48px; height: 48px; background: #26B99A; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                                    <i class="fa fa-exchange" style="color: white; font-size: 20px;"></i>
                                                </div>
                                                <div>
                                                    <div style="font-size: 13px; color: #26B99A; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px; font-weight: 600;">Change</div>
                                                    <div style="font-size: 32px; font-weight: bold; color: #26B99A;">₱ ${change.toFixed(2)}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            let successHtml = `
                            <div style="padding: 4px 0; margin-top: 7px;">
                                <div style="background: #ffffff; border-radius: 12px; padding: 15px; border: 1px solid #e9ecef; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
                                    <div style="margin-bottom: 12px; padding-bottom: 10px; border-bottom: 1px solid #e9ecef;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-shopping-cart" style="color: #6c757d; margin-right: 10px; font-size: 15px;"></i>
                                                <span style="font-weight: 600; color: #495057; font-size: 13px;">Subtotal:</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 17px; font-weight: 600; color: #495057; text-align: right; letter-spacing: -0.3px;">₱ ${finalSubtotal.toFixed(2)}</div>
                                    </div>`;
                            ...
                            if (discountAmount > 0) {
                                successHtml += `
                                    <div style="margin-bottom: 12px; padding-bottom: 10px; border-bottom: 1px solid #e9ecef;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-tag" style="color: #26B99A; margin-right: 10px; font-size: 15px;"></i>
                                                <span style="font-weight: 600; color: #26B99A; font-size: 13px;">Discount (${selectedDiscountValue}%):</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 17px; font-weight: 600; color: #26B99A; text-align: right; letter-spacing: -0.3px;">-₱ ${discountAmount.toFixed(2)}</div>
                                    </div>`;
                            }
                            ...
                            successHtml += `
                                    <div style="margin-bottom: 12px; padding-bottom: 10px; border-bottom: 1px solid #e9ecef;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-percent" style="color: #6c757d; margin-right: 10px; font-size: 15px;"></i>
                                                <span style="font-weight: 600; color: #495057; font-size: 13px;">VAT (12%):</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 17px; font-weight: 600; color: #495057; text-align: right; letter-spacing: -0.3px;">₱ ${finalVat.toFixed(2)}</div>
                                    </div>
                                    
                                    <div style="margin-bottom: 10px; padding-bottom: 10px; border-bottom: 2px solid #e9ecef;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-shopping-cart" style="color: #26B99A; margin-right: 10px; font-size: 17px;"></i>
                                                <span style="font-weight: 700; color: #2A3F54; font-size: 15px;">Total Amount:</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 24px; font-weight: 700; color: #000000; text-align: right; letter-spacing: -0.5px;">₱ ${finalTotal.toFixed(2)}</div>
                                    </div>
                                    
                                    <div style="margin-bottom: 10px; padding-bottom: 10px; border-bottom: 1px solid #e9ecef;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-money-bill-wave" style="color: #26B99A; margin-right: 10px; font-size: 17px;"></i>
                                                <span style="font-weight: 600; color: #495057; font-size: 14px;">Payment:</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 21px; font-weight: 700; color: #2A3F54; text-align: right; letter-spacing: -0.5px;">₱ ${payment.toFixed(2)}</div>
                                    </div>
                                    
                                    <div style="background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); border-radius: 10px; padding: 10px; margin-top: 8px; border: 1px solid #a5d6a7;">
                                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 5px;">
                                            <div style="display: flex; align-items: center;">
                                                <i class="fa fa-exchange-alt" style="color: #26B99A; margin-right: 10px; font-size: 17px;"></i>
                                                <span style="font-weight: 700; color: #26B99A; font-size: 14px;">Change:</span>
                                            </div>
                                        </div>
                                        <div style="font-size: 24px; font-weight: 700; color: #007bff; text-align: right; letter-spacing: -0.5px;">₱ ${finalChange.toFixed(2)}</div>
                                    </div>
                                </div>
                            </div>`;
                            ...
                            Swal.fire({
                                icon: null,
                                title: '<div style="font-size: 24px; font-weight: 700; color: #2A3F54; margin-bottom: 0; text-align: center; letter-spacing: -0.5px;"><i class="fa fa-check-circle" style="color: #26B99A; margin-right: 10px; font-size: 26px;"></i>Checkout Successful!</div>',
                                html: successHtml,
...
.swal-confirm-btn:hover {
    ...
    box-shadow: 0 6px 20px rgba(38, 185, 154, 0.4) !important;
}
