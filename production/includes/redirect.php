...
// Get redirect destination from session
...
<head>
    ...
    <title>Login Successful - TCI</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="redirect-container">
        ...
        <p class="welcome-message">
            Welcome back, <span class="user-name"><?php echo htmlspecialchars($user_name); ?></span>!<br>
    ...
    <script>
        // Redirect after 3 seconds (same as Session Terminated)
        setTimeout(function() {
